...
import useWordSearchIndex from '../hooks/useWordSearchIndex.js'
...
function Home() {
  ...
  const {
    results: wordResults,
    showResults: showWordResults,
    setShowResults: setShowWordResults,
    indexedCount,
    buildFailed: indexFailed,
    retry: retryIndexBuild,
  } = useWordSearchIndex(debouncedWordQuery)
                ...
                <>
                  ...
                  {filteredDictionaries.map((dict, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`absolute top-0 left-0 w-full h-1 ${getCategoryColor(dict.name)} opacity-80 dark:opacity-50`}
                        />
                        <button
                          onClick={(e) => {
                            e.stopPropagation()
