...
function VideoCard({ video, isBookmarked = false, onClick, onToggleBookmark }) {
  ...
  return (
    <div
      ...
      className="group card card-hover relative overflow-hidden cursor-pointer glow-border-subtle active:scale-[0.98] transition-transform duration-150 flex flex-col rounded-xl shadow-sm h-auto max-h-[480px] md:h-[480px]"
    >
      {/* 收藏按钮 */}
      <button
        onClick={(e) => {
