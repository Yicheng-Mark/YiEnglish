...
export const DICT_BADGE_CLASS = {
  ...
  ieltsfreq: 'bg-violet-100 text-violet-700 dark:bg-violet-500/15 dark:text-violet-300',
  toefl: 'bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/15 dark:text-fuchsia-300',
  toeflfreq: 'bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/15 dark:text-fuchsia-300',
...
// 模块级共享 regex：ColorizedText 每次渲染都调用，若每次 new RegExp 会产生
// 大量临时对象。matchAll 要求 g 标志且会沿用源 regex 的 lastIndex，
// 用前重置一次保证从头匹配（JS 单线程，安全）
