...
export const dictionaryMeta = [
  ...
  { id: 'programmer', name: '程序员英语', category: '专业英语', description: '程序员核心专业英语词汇，覆盖编程语言、数据结构、算法、操作系统、网络协议、前后端开发、数据库、软件工程、安全、云计算、DevOps、AI/ML、大数据等领域', totalWords: 1538, color: warmColors[7] },
