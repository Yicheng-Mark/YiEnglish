...
export const dictionaryMeta = [
  ...
  },
  {
    ...
    name: '雅思高频',
    category: '留学英语',
    description: '依据 ECDICT 考试大纲标签与 BNC/COCA 词频筛选的雅思高频核心词汇',
    totalWords: 1500,
    color: warmColors[6],
  },
  {
  ...
  },
  {
    ...
    name: '托福高频',
    category: '留学英语',
    description: '依据 ECDICT 考试大纲标签与 BNC/COCA 词频筛选的托福高频核心词汇',
    totalWords: 1500,
    color: warmColors[7],
  },
  {
  ...
  },
  {
    ...
    category: '专业英语',
    description:
      '程序员核心专业英语词汇，覆盖编程语言、数据结构、算法、操作系统、网络协议、前后端开发、数据库、软件工程、安全、云计算、DevOps、AI/ML、大数据等领域',
    totalWords: 1538,
    color: warmColors[7],
  },
  {
    ...
    category: '船员考试',
    description:
      '海船船员适任考试（航海英语）大纲词汇，依据《中华人民共和国海船船员考试大纲（2022版）》和《海船船员培训大纲（2021版）》整理，涵盖船舶结构、操纵避碰、航海仪器、货物装卸、轮机设备、船舶通信、安全应急、气象观测、国际公约、船员职务等主题。',
    totalWords: 1565,
    color: warmColors[7],
  },
  {
    ...
    category: '专业英语',
    description:
      '轮机英语专业词汇，覆盖主推进装置、辅机系统、电气与自动化、消防与救生、船舶维修与检验、国际公约与法规、轮机管理、业务写作与通信等全部适任考试板块。参考郑高《轮机英语词汇》（国防工业出版社，2022）和李品友《轮机英语词汇手册》（人民交通出版社，2005）等权威资料编制，收录约5,200词条。',
    totalWords: 5215,
    color: warmColors[4],
  },
  {
    ...
    category: '专业英语',
    description:
      '基于GB/T 5624-2019、SAE J1930、SAE J670、SAE J645、SAE J3016五大权威标准构建的汽车维修英语词库，涵盖发动机、传动系统、底盘、制动系统、电气系统等核心领域',
    totalWords: 1645,
    color: warmColors[1],
  },
  {
    ...
    category: '专业英语',
    description:
      '面向电工、电气维修工、自动化技术人员的专业英语词汇库，涵盖电学基础、电路元件、电机变压器、PLC控制、仪器仪表、电气安全等核心领域',
    totalWords: 936,
    color: warmColors[3],
  },
  {
    ...
    name: '商务英语',
    category: '专业英语',
    description: '基于剑桥商务英语BEC标准的纯商务核心词汇，覆盖初级、中级、高级',
    totalWords: 6000,
    color: warmColors[0],
  },
  {
    ...
    category: '专业英语',
    description:
      '基于外销员全国统一考试大纲、对外经济贸易大学880万词商务英语语料库、外贸单证员考试三大权威来源，覆盖实用外贸商务英语核心词汇，涵盖贸易术语、商务函电、单证、支付、运输、保险、报关、谈判、合同、展会、跨境电商等外贸全流程。',
    totalWords: 4000,
    color: warmColors[5],
  },
  {
    ...
    category: '专业英语',
    description:
      '面向厨师、烘焙师、餐饮管理人员的专业英语词汇库，涵盖食材、技法、设备、管理、食品安全、营养及服务等10大类别',
    totalWords: 1248,
    color: warmColors[2],
  },
